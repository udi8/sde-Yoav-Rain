...
אתר מד-גשם ציבורי לקיבוץ שדה יואב, במקום קבוצת הוואטסאפ של יגאל שרוני.
...
`scripts/parseWhatsapp.js` מפרסר קובץ `_chat.txt` (ייצוא צ'אט וואטסאפ) להודעות המשקעים של יגאל, ומדלג על כל שאר ההודעות. הוא סלחני לגבי הפורמט (עם/בלי מקף, "ממ" מול "מ\"מ", רווחים מיותרים וכו') ומדפיס לקונסול כל מקרה גבולי שהוא לא הצליח לפרסר, כדי שתוכל לבדוק אותו ידנית.
