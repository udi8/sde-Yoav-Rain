...
אתר מד-גשם ציבורי לקיבוץ שדה יואב, לצד קבוצת הוואטסאפ למעקב אחר משקעים — לא במקומה: האתר שומר את ההיסטוריה ומציג אותה בגרפים, ומאפשר לשלוח כל מדידה ישירות לוואטסאפ לאותה רשימת תפוצה בלחיצה אחת.
